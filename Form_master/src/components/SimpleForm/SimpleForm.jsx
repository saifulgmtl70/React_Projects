                    ...
                    <form action="" onSubmit={handleSubmit} className="mb-0 mt-6 space-y-4 rounded-lg p-4 sm:p-6 lg:p-8">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input type="email" className="w-full rounded-lg border-slate-600 p-4 pe-12 text-lg shadow-lg" name="email" placeholder="Enter email"/>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input type="password" className="w-full rounded-lg border-rose-700 p-4 pe-12 text-lg shadow-lg" name="password" placeholder="Enter password"/>
                            </div>
                        </div>
