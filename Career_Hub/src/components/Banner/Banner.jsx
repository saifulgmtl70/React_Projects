        ...
        <section className="bg-base-200">
            <div className="mb-10 px-12 y-10">
                <div className="flex flex-col lg:flex-row justify-between items-center gap-12">
                    <div>
                        <h2 className="text-5xl text-slate-800 font-semibold">One Step Closer To Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Dream Job</span> </h2>
